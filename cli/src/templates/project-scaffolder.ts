...
export class ProjectScaffolder {
   ...
   */
  async scaffold(template: ProjectTemplate, targetDir: string): Promise<void> {
...
`
   ...
   */
  private getExpressAPITemplate(): ProjectTemplate {
    return {
      name: 'express-api',
...
`
   ...
   */
  private getReactLibraryTemplate(): ProjectTemplate {
    return {
      name: 'react-library',
...
`
   ...
   */
  private getPythonMLTemplate(): ProjectTemplate {
    return {
      name: 'python-ml',
...
`
   ...
   */
  private getQuantumProjectTemplate(): ProjectTemplate {
    return {
...
`
   ...
   */
  private getDockerizedFullStackTemplate(): ProjectTemplate {
    return {
...
`
   ...
   */
  private getMicroserviceTemplate(): ProjectTemplate {
    return {
      name: 'microservice',
